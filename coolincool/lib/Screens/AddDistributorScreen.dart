...
class AddDistributorScreen extends StatefulWidget {
  ...
  @override
  _AddDistributorScreenState createState() => _AddDistributorScreenState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Add Distributor",style: TextStyle(fontSize: 23),),
        centerTitle: true,
            ...
            children: [
              ...
              Container(
                ...
                child: DropdownButtonFormField(
                  ...
                  decoration: InputDecoration(
                    labelText: "Reference Distributor",
                    border: InputBorder.none,
                    contentPadding:
                    EdgeInsets.fromLTRB(20.0, 0.0, 0.0, 8.0),
                    fillColor: Colors.white,
    ...
    return showDialog(
        ...
        builder: (BuildContext context) {
          return CustomDialogBox(
            ...
            descriptions: "Distributor Added Successfully",
            text: "Okay",
          );
        });
  }
