...
class SubGeneralCategory extends StatefulWidget {
  @override
  _SubGeneralCategoryState createState() => _SubGeneralCategoryState();
}

class _SubGeneralCategoryState extends State<SubGeneralCategory> {
  String text1 = 'CH0002';
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                        ...
                        colorFilter: ColorFilter.mode(
                            Color(0xffADDFDE).withOpacity(0.5),
                            BlendMode.dstATop),
                        fit: BoxFit.cover)),
                child: Column(
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsets.only(bottom: 30.0, top: 120.0),
                        child: Text(
                          'QUEUING MANAGEMENT SYSTEM',
                          style: TextStyle(
                              color: Color(0xff004080), fontSize: 22.0),
                        ),
                      ),
                      Padding(
