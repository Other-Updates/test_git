...
class Emailacknowledge extends StatefulWidget {
  @override
  EmailacknowledgeState createState() => EmailacknowledgeState();
}

class EmailacknowledgeState extends State<Emailacknowledge> {
  String customer_details;
  var _GENERIC_EMAIL_CHANGES_MSG = ' ',
      GENERIC_TRY_AGAIN = ' ',
      GENERIC_OR = ' ',
  ...
  getLanguage() async {
    ...
    setState(() {
      _GENERIC_EMAIL_CHANGES_MSG = Language.getLocalLanguage(
          _sharedPreferences, 'GENERIC_EMAIL_CHANGES_MSG');
      GENERIC_TRY_AGAIN =
          Language.getLocalLanguage(_sharedPreferences, 'GENERIC_TRY_AGAIN');
      GENERIC_OR = Language.getLocalLanguage(_sharedPreferences, 'GENERIC_OR');
      GENERIC_CONTACT_SUPPORT = Language.getLocalLanguage(
          _sharedPreferences, 'GENERIC_CONTACT_SUPPORT');
      GENERIC_CHANGE_MOBILE_NUMBER = Language.getLocalLanguage(
      ...
      child: ListView(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              width: 180,
              child:
                  Image.asset('assets/images/otpsuccess.png', fit: BoxFit.fill),
            ),
            Container(
              alignment: Alignment.center,
              padding: EdgeInsets.only(left: 15.0, right: 15.0, top: 30),
              child: Text(
                _GENERIC_EMAIL_CHANGES_MSG,
