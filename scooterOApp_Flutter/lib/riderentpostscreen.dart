...
class RideRentPostScreen extends StatefulWidget {
  @override
  final trip_details;
  RideRentPostScreen(this.trip_details);
  _RideRentPostScreenState createState() => _RideRentPostScreenState(this.trip_details);
  }
  class _RideRentPostScreenState extends State<RideRentPostScreen> {

  final trip_details;
  _RideRentPostScreenState(this.trip_details);


  var _GENERIC_RIDE_RENT = ' ', _GENERIC_RIDE_PAYMENT = '', _GENERIC_PLAN_PURCHASED ='', _GENERIC_PAID_AMOUNT = ' ', _GENERIC_START_TIME = '', _GENERIC_END_TIME= '', _GENERIC_UNLOCK_CHARGE = ' ', _GENERIC_SUB_TOTAL = '', _GENERIC_VAT ='',_GENERIC_GRAND_TOTAL = ' ', _GENERIC_CONTINUE = '', _GENERIC_REPORT_ISSUE_MSG ='',_GENERIC_TOTAL_RIDE_TIME = ' ', _GENERIC_RIDE_DISTANCE='' ;
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      appBar: AppBar(
        ...
        title: Text(_GENERIC_RIDE_RENT,style: TextStyle(color:Colors.white,fontWeight: FontWeight.bold),),
        centerTitle: true,
      ...
      body: new Container(
        ...
        child: new ListView(
          children: <Widget>[
            ...
            Container(
                padding: EdgeInsets.fromLTRB(15.0, 5.0, 10.0, 0),
                child: new Card(
                  color: Colors.white,
                  child: new Column(
                      children: [
                                ...
                                children: <Widget>[
                                  ...
                                  Flexible(
                                    child: Padding(
                                        ...
                                        child: Container(
                                          alignment: Alignment.centerRight,
                                          child: Text('${trip_details['ride_distance']}KM',style: TextStyle(fontFamily: 'Montserrat',color: Color(0xff676767))),
                                        )  ),
                                    flex: 2,
                                  ),
                                ] )  ),
                                  ...
                                  Flexible(
                                    child: Padding(
                                        ...
                                        child: Container(
                                            ...
                                            //   height: MediaQuery.of(context).size.height ,
                                            //  width:MediaQuery.of(context).size.width
                                            child: Text(_GENERIC_TOTAL_RIDE_TIME,style: TextStyle(fontFamily: 'Montserrat',color: Color(0xff676767)))
                                        )     ),
                                    flex: 2,
                                  ),
                                  Flexible(
                                    child: Padding(
                                        ...
                                        child: Container(
                                          alignment: Alignment.centerRight,
                                          child: Text('${trip_details['ride_mins']}SAR',style: TextStyle(fontFamily: 'Montserrat',color: Color(0xff676767))),
                                        )  ),
                                    flex: 2,
                                  ),
                                ] )  ),
                                  ...
                                  Flexible(
                                    child: Padding(
                                        ...
                                        child: Container(
                                            ...
                                            //   height: MediaQuery.of(context).size.height ,
                                            //  width:MediaQuery.of(context).size.width
                                            child: Text(_GENERIC_VAT,style: TextStyle(fontFamily: 'Montserrat',color: Color(0xff676767)))
                                        )     ),
                                    flex: 2,
                                  ),
                                  Flexible(
            ...
            Container(
                padding: EdgeInsets.fromLTRB(15.0, 5.0, 10.0, 5),
                child: new Card(
                  ...
                  child: new Row(
                      ...
                      children: <Widget>[
                        Flexible(
                          child: Padding(
                              padding:
                              EdgeInsets.only(right: 10.0,top: 20,bottom: 20),
                              child: Container(
                                  alignment: Alignment.centerLeft,
                                  padding: EdgeInsets.only(left: 15),
