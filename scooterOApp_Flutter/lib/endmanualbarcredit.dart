...
import 'package:scotto/riderentpostscreen.dart';
...
class EndManualbarCredit extends StatefulWidget {
  @override
  final trip_details;
  EndManualbarCredit(this.trip_details);
  _EndManualbarCreditState createState() =>
      _EndManualbarCreditState(this.trip_details);
}

class _EndManualbarCreditState extends State<EndManualbarCredit> {
  final trip_details;
  _EndManualbarCreditState(this.trip_details);
              ...
              Container(
                  ...
                  child: RaisedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).pushReplacement(MaterialPageRoute(
                          builder: (BuildContext context) =>
                              RideRentPostScreen(trip_details)));
                    },
                  )),
            ])));
      },
