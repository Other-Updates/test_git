...
import 'package:scotto/changemobileackknowledge.dart';
...
class MobilenumberotpVerify extends StatefulWidget {
  String customer_details;
  MobilenumberotpVerify(customer_details);
  @override
  _MobilenumberotpVerifyState createState() => _MobilenumberotpVerifyState();
}

class _MobilenumberotpVerifyState extends State<MobilenumberotpVerify>
    ...
    if (response.statusCode == 200) {
      ...
      if (jsonResponse['status'] == 'Success') {
        ...
        Navigator.of(context).pushReplacement(MaterialPageRoute(
            builder: (BuildContext context) => Changemobileacknowledge()));
