...
import 'package:scotto/editprofileacknowledge.dart';
...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  void getEditableText() async {
    try {
      ...
      String data2 =
      await StorageUtil.getItem("login_customer_detail_mobile_gender");
      String data3 =
      await StorageUtil.getItem("login_customer_detail_mobile_number");
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          prefixIcon: Icon(Icons.person_outline,
                              color: Color(0xff00DD00), size: 28),
                                  ...
                                  child: TextFormField(
                                      ...
                                      //  contentPadding: EdgeInsets.fromLTRB(5, 15, 5, 0),
                                        prefixIcon: Icon(Icons.date_range,
                                            color: Color(0xff00DD00), size: 26),
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(StringProperty('mobile_test4', mobile_test4));
    properties.add(StringProperty('mobile_test4', mobile_test4));
  }
}
