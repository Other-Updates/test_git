...
class EditServiceScreen extends StatefulWidget {
  ...
  _EditServiceScreenState createState() => _EditServiceScreenState(this.leads_list);
}
...
class _EditServiceScreenState extends State<EditServiceScreen> {
  ...
  customer() async {
    ...
    var data = json.encode({"customer_id":mobile_test6, "service_id":leads_list['id'],"service_type":"customer","emp_id":mobile_test6});
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    focusColor: Colors.grey,
                      hintText: leads_list['description']??" ",fillColor: Colors.black,
               ...
               //padding: EdgeInsets.only(bottom: 20.0, right: 10.0),
                ...
                child: Row(
                    ...
                    children: [
                      ...
                      Expanded(
                          child: Text(leads_list['attendant']??" ",
              ...
              //  padding: EdgeInsets.only(bottom: 20.0, right: 10.0),
                ...
                child: Row(
                    ...
                    children: [
                      Expanded(
                          child:
                          Text('Mobile number         :  ${leads_list['attendant_mobile_no']??" "}',
                            style: TextStyle(
                              fontSize: 17,
                              color: Colors.black,
                            ),
