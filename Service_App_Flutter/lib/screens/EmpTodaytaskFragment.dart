            ...
            child: Container(
              child: Column(
                children: <Widget>[
                                  ...
                                  child: GestureDetector(
                                    onTap: () {
                                      ...
                                      Navigator.of(context).pushReplacement(
                                          MaterialPageRoute(
                                              builder: (BuildContext context) =>
                                                  EmpTodaytaskFragment()));
                                      // showall();
                                    },
                                    child: Icon(
                                      Icons.refresh_outlined,
                                      color: Colors
                                          .black54, // add custom icons also
                                    ),
                                  ),
                                  flex: 1,
                                ),
                  ...
                  Container(
                      height: 55,
                      padding: EdgeInsets.fromLTRB(9, 8, 5, 0),
                      child: new Row(
                        mainAxisSize: MainAxisSize.max,
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: <Widget>[
                                ...
                                Flexible(
                                  child: Padding(
                                    padding: EdgeInsets.only(
                                        right: 10.0, left: 5.0, bottom: 5.0),
                                    child: Visibility(
                                        maintainSize: false,
                                        maintainAnimation: true,
                                        maintainState: true,
                            ...
                            child: Container(
                              ...
                              child: new Column(
                                  ...
                                  children: <Widget>[
                                    Container(
                                        padding:
                                            EdgeInsets.only(left: 6.0, top: 8),
