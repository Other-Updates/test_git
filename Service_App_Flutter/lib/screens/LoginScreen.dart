...
class _LoginScreenState extends State<LoginScreen> {
  ...
  // emp_login
   ...
   customer() async {
     ...
     // }
     var data = json.encode({"mobile_number": phonenumberController.text, "password": passwordController.text});
     final response = await http.post('https://demo.f2fsolutions.co.in/serviceAPP/api/cust_login', headers: {'authorization': basicAuth}, body: data);
     print(data);
     if (response.statusCode == 200) {
       ...
       if(jsonResponse['status'] == "Success"){
         ...
         setState(() {
           ...
           StorageUtil.setItem("login_customer_mobil_number", customer_details['mobil_number']);
           StorageUtil.setItem("login_customer_email_id", customer_details['email_id']);
           StorageUtil.setItem("login_customer_created_date", customer_details['created_date']);
           StorageUtil.setItem("login_customer_type", customer_details['type']);
           StorageUtil.setItem("login_customer_profile_image", customer_details['profile_image']);
           print(customer_details['profile_image']);
           StorageUtil.setItem("login_customer_password",JsonEncoder().convert(customer_details['password']));
           print("hjhgghg"+JsonEncoder().convert(customer_details['password']));
         });


         Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (BuildContext context) => CusHomeFragment()), (Route<dynamic> route) => false);
 ...
 // emp_login
  Employee() async {
   ...
   /* if (!isValid) {
    ...
    var data = json.encode({"username":EmpnameController.text, "password": EmppasswordController.text,"login_location":EmpLocationController.text});
    final response = await http.post(BASE_URL+'emp_login', headers: {'authorization': basicAuth}, body: data);
    print(data);
    if (response.statusCode == 200) {
      var jsonResponse = json.decode(response.body);
      print(jsonResponse);
      if(jsonResponse['status'] == "Success"){
        ...
        StorageUtil.setItem("login_employee_name", Employee_details['username']);
        StorageUtil.setItem("login_employee_mobil_number", Employee_details['mobile_no']);
        StorageUtil.setItem("login_employee_email_id", Employee_details['email_id']);
        StorageUtil.setItem("login_employee_created_date", Employee_details['created_date']);
        StorageUtil.setItem("login_employee_type",Employee_details['type']);
        Navigator.of(context).pushAndRemoveUntil(MaterialPageRoute(builder: (BuildContext context) => EmphomeFragment()), (Route<dynamic> route) => false);
              ...
              fontSize: 17.0,
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      labelStyle:TextStyle(
                          color: myFocusNode1.hasFocus ?Color(0xff004080):Colors.grey),
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText: 'Password',
                      labelStyle:TextStyle(
                          color: myFocusNode2.hasFocus ? Color(0xff004080) :Colors.grey),
                      contentPadding: EdgeInsets.fromLTRB(20.0, 15.0, 20.0, 15.0),
                      fillColor: Colors.white,
                      ...
                      //  height: 70,
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            labelStyle:TextStyle(
                                color: myFocusNode3.hasFocus ? Color(0xff004080) :Colors.grey),
                            contentPadding: EdgeInsets.fromLTRB(20.0, 15.0, 20.0, 15.0),
                            fillColor: Colors.white,
                            border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(32.0)
                    ...
                    //    height: 70,
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: 'Password',
                            labelStyle:TextStyle(
                                color: myFocusNode4.hasFocus ? Color(0xff004080) :Colors.grey),
                            contentPadding: EdgeInsets.fromLTRB(20.0, 15.0, 20.0, 15.0),
                            fillColor: Colors.white,
                            border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(32.0)
                  ...
                  Visibility(
                     ...
                     //   height: 70,
                        ...
                        child: TextFormField(
                          ...
                          controller: EmpLocationController,
                          decoration: InputDecoration(
                            labelText: 'Location',
                            labelStyle:TextStyle(
                                color: myFocusNode5.hasFocus ? Color(0xff004080) :Colors.grey),
                            contentPadding: EdgeInsets.fromLTRB(20.0, 15.0, 20.0, 15.0),
                            fillColor: Colors.white,
                            border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(32.0)
                          ...
                          children: <Widget>[
                            ...
                            new GestureDetector(
                              child: Text('  Signup here' ,  style: new TextStyle(
                                fontSize: 15.0,color: Color(0xff004080),
                              ),),
                              onTap: () {
