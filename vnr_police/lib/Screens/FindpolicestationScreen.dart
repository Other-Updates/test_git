...
class FindPoliceStationScreen extends StatefulWidget {
  const FindPoliceStationScreen({Key? key}) : super(key: key);

  @override
  _FindPoliceStationScreenState createState() =>
      _FindPoliceStationScreenState();
}
...
class _FindPoliceStationScreenState extends State<FindPoliceStationScreen> {
  ...
  final List<PoliceStation> policeStations = [
    PoliceStation(
      name: "Virudhunagar Police Station",
