...
class FindWomanPoliceStation extends StatefulWidget {
  const FindWomanPoliceStation({Key? key}) : super(key: key);

  @override
  _FindWomanPoliceStationState createState() => _FindWomanPoliceStationState();
}
...
class _FindWomanPoliceStationState extends State<FindWomanPoliceStation> {
  ...
  final List<PoliceStation> policeStations = [
    PoliceStation(
      name: "Virudhunagar Woman's Station",
